...
bool Log::init(const char* file_name, int close_log, int max_queue_size, int log_buf_size, int split_lines)
{
...
void Log::write_log(int level, const char* format, ...)
{
	...
	//内容格式化，用于向字符串打印数据、数据格式用户自定义，返回写入到字符数组str的字符字数(不包含终止符)
